    ...
    public void onItemClick(int position) {
        ...
        if (PermissionsManager.getInstance().isPermissionGranted(this, permissionName)) {
            ...
            showToast("Permission " + model.getPermissionName() + "  is granted");
                ...
                //PermissionsManager.getInstance().requestPermissionIfNotGranted(this, true, permissionName, PERMISSION_REQUEST_CODE);
                PermissionUtils.handlePermissionRequest(this, permissionName);
            }
